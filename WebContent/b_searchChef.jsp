	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
					...
					<div class="forms">
					<center><h3 class="title1">Search Chef</h3></center>
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4>Enter Following Details :</h4>
						</div>
						<div class="form-body">
							<form action="b_searchChef.jsp" method="post"> 
								
								
								<div class="form-group"> 
									<label for="exampleInputEmail1">City</label> 
									<input type="text" name="ccity" class="form-control" id="exampleInputEmail1" placeholder="Enter City"> 
								</div>
								<div class="form-group"> 
									<label for="exampleInputEmail1">Speciality</label> 
									<input type="text" name="cspeciality" class="form-control" id="exampleInputEmail1" placeholder="Enter Speciality"> 
								</div>
						...
						try 
						{
							...
							{%>	 
								<tr>
									...
									<td><a href="b_bookingChef.jsp?cid=<%=rs.getInt(1)%>">booking</a></td>
								</tr>	
							<%}
