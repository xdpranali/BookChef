...
<body class="cbp-spmenu-push">
	<div class="main-content">
            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						...
						<li>
							<a href="b_8_viewApprovedChef.jsp"><i class="fa fa-table nav_icon"></i>viewApprovedChef</a>
						</li>
						<li>
							<a href="b_9_viewDapprovedChef.jsp"><i class="fa fa-cogs nav_icon"></i>viewDapprovedChef</a>
						</li>
						<li>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1">View Users</h3>
					<a href="b_viewUsers.jsp"></a>
