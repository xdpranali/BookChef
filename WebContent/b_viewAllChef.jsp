	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
					...
					<div class="forms">
					<center><h3 class="title1">View All Chefs</h3></center>
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4>Enter Following Details :</h4>
						</div>
						<div class="form-body">
							<form action="b_viewAllChef.jsp" method="post"> 
					...
					<table class="table table-bordered">
					    ...
					    PreparedStatement ps1 = con.prepareStatement("select * from chef where ccity IS Not null");
						...
						{%>
							...
							PreparedStatement ps = con.prepareStatement("select * from chef where ccity=?");
